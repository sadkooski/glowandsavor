...
return (
    <div className="">
      ...
      <p className="w-[33%] pt-[7vw] text-[1.8vw] text-right font-[Didonesque]">
        Lorem ipsum, dolor sit amet consectetur Blanditiis, eveniet fugiat unde molestiae, ab dolore aliquid sint enim ipsum, facere voluptates omnis. , error ad nemo unde adipisci?e
      </p>
      ...
      <p className="w-[25%] pt-[5vw] text-[1.6vw] font-normal absolute left-[8vw] z-1 font-[Didonesque]">
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Blanditiis, abs non, error ad nemo undec i?edasdas afdf sfgegwe rewrgwerg ewrgewrgerwg
      </p>
      ...
      <div className="px-[8vw] pt-[2vw] pb-[5vw] text-center bg-gray-100 ">
      <h3 className="text-[4vw] ">Follow our feed</h3>
      <a
        href="https://www.instagram.com/glowandsavor"
        target="_blank"
        rel="noopener noreferrer"
        className=" text-[2vw] font-medium mt-[4vw]"
        >
        @glowandsavor
      </a>
