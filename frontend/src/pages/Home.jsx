...
return (
    <div className="">
      ...
      <div className="w-[34%] py-[3vw] bg-gray-600">
        <img src="glow-savor/assets/hero-img.jpeg" alt="" className="w-full" />
      </div>
      ...
      <img src="glow-savor/assets/my-name-img.jpeg" alt="" className="w-[45%] z-0 ml-auto"/>
      ...
      <li className="w-full"><img src="glow-savor/assets/img-1.jpg" alt="Image 1" className="w-full aspect-square object-cover" /></li>
      <li className="w-full"><img src="glow-savor/assets/img-2.jpg" alt="Image 2" className="w-full aspect-square object-cover" /></li>
      <li className="w-full"><img src="glow-savor/assets/img-3.jpg" alt="Image 3" className="w-full aspect-square object-cover" /></li>
      <li className="w-full"><img src="glow-savor/assets/img-4.jpg" alt="Image 1" className="w-full aspect-square object-cover" /></li>
      <li className="w-full"><img src="glow-savor/assets/img-11.jpg" alt="Image 2" className="w-full aspect-square object-cover" /></li>
      <li className="w-full"><img src="glow-savor/assets/img-14.jpg" alt="Image 3" className="w-full aspect-square object-cover" /></li>
      <li className="w-full"><img src="glow-savor/assets/img-7.jpg" alt="Image 1" className="w-full aspect-square object-cover" /></li>
      <li className="w-full"><img src="glow-savor/assets/img-8.jpg" alt="Image 2" className="w-full aspect-square object-cover" /></li>
      <li className="w-full"><img src="glow-savor/assets/img-12.jpg" alt="Image 3" className="w-full aspect-square object-cover" /></li>
      </ul>
      </div>
