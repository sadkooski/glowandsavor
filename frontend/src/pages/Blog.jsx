...
const Blog = () => {
    return (
        <section className="w-full bg-white px-[7vw] pt-[3vw]">
            <div className="flex justify-center items-center bg-[url('/assets/header-bg.jpeg')] bg-cover bg-center h-[24vw]">
            ...
            <div className="flex flex-col px-[8vw] py-[8vw] text-gray-700">
                <div className="flex flex-col gap-[1vw] text-left">
                <p className="text-[1.2vw] leading-relaxed">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Maiores necessitatibus quibusdam distinctio aliquid voluptate cum nemo quod consequuntur eaque molestiae fugiat, ex voluptas. Facilis, debitis quae rerum sapiente ab dolore.</p>
                <p className="text-[1.2vw] leading-relaxed">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore excepturi natus dolorem voluptate id saepe incidunt hic sequi dolorum rerum ratione veritatis, enim aperiam quasi, perferendis voluptatum assumenda quibusdam ducimus?</p>
                <h3 className="text-[2.5vw] leading-tight py-[0.5vw]">Lorem ipsum dolor  consequatur alias, non aliquam vel at expedita quaerat explicabo.</h3>
