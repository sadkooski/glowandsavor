...
const Footer = () => {
    return (
        <footer className="bg-white  pb-[5vw] pt-[5vw] mt-auto w-full">
            <div className="mx-[8vw]">
                ...
                <div className="flex items-center justify-between border-b-[0.1vw] border-black pb-[3vw]">
                    ...
                    {/* Logo po prawej */}
                    <div className="text-[1.2vw] font-bold">LOGO</div>
                </div>

                {/* Dolna sekcja z nawigacją */}
                <div className="flex justify-center gap-[15vw] text-[1.5vw] border-gray-200 pt-[1.5vw] font-[Didonesque]">
